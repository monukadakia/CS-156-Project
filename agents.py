...
class Agent(object):
    ...
    def start_scheduling(self):
        ...
        user_input = raw_input("Do you want to graduate with a Higher GPA (A) or graduate within 4 years (B). Type A or B: ").replace(" ", "").upper()
        while not(user_input == "A" or user_input == "B"):
            user_input = raw_input("Type A or B: ").replace(" ", "").upper()
...
#         self.findClasses()
#         print "Class: ", self.classAvailable
#         for x in final_schedule:
